...
- Decred-branded borrow UI modeled on the clean Liquidium-style instant-loan card.
- Live market adapters for Kraken, DCRDEX, DIA, CoinGecko, and CoinPaprika where reachable.
- Simulated 1% platform fee shown in quotes and loan records.
- Seeded demo loans and events.
- Unit tests for LTV/risk logic and the loan state machine.
- CI workflow for audit, tests, lint, build, and Semgrep TypeScript scanning.
...
- Public market-data calls to Kraken, DCRDEX, DIA, CoinGecko, and CoinPaprika.
- Research-backed design for Decred 2-of-3 escrow.
- Demo platform-fee math and operator revenue display.
...
docs/                  User, operator, risk, readiness, simnet, and ticket-collateral docs
...
See `docs/PRODUCTION_READINESS.md` and `docs/simnet/README.md` for the next execution gates.
